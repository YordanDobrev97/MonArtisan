        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KbisDocument = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategoryQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubCategoryQuestions_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubCategoryQuestions_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubCategoryQuestions_SubCategories_SubCategoryId",
                        column: x => x.SubCategoryId,
                        principalTable: "SubCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryQuestions_AnswerId",
                table: "SubCategoryQuestions",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryQuestions_IsDeleted",
                table: "SubCategoryQuestions",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryQuestions_QuestionId",
                table: "SubCategoryQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SubCategoryQuestions_SubCategoryId",
                table: "SubCategoryQuestions",
                column: "SubCategoryId");
